...
[![Greenkeeper badge](https://badges.greenkeeper.io/andreslon/angular-starter-template.svg)](https://greenkeeper.io/)

[![Angular Style Guide](https://andreslon.github.io/angular2-style-guide/images/badge.svg)](https://angular.io/styleguide)
[![Build Status](https://travis-ci.org/andreslon/angular-starter-template.svg?branch=master)](https://travis-ci.org/andreslon/angular-starter-template)
[![Build Status](https://ci.appveyor.com/api/projects/status/jg5vg36w0klpa00e/branch/master?svg=true)](https://ci.appveyor.com/project/andreslon/angular2-seed)
[![Join the chat at https://gitter.im/andreslon/angular2-seed](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/andreslon/angular2-seed?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
[![Dependency Status](https://david-dm.org/andreslon/angular-starter-template.svg)](https://david-dm.org/andreslon/angular-starter-template)
[![devDependency Status](https://david-dm.org/andreslon/angular-starter-template/dev-status.svg)](https://david-dm.org/andreslon/angular-starter-template#info=devDependencies)
...
`angular-starter-template` provides the following features:
...
**Here is how to [speed-up the build on Windows](https://github.com/andreslon/angular-starter-template/wiki/Speed-up-the-build-on-Windows)**.

In order to start the seed use:


```bash
$ git clone --depth 1 https://github.com/andreslon/angular-starter-template.git
...
Visit the [Wiki page](https://github.com/andreslon/angular-starter-template/wiki) of the project.

# How to update?
```
git remote add upstream https://github.com/andreslon/angular-starter-template
...
Please see the [CONTRIBUTING](https://github.com/andreslon/angular-starter-template/blob/master/.github/CONTRIBUTING.md) file for guidelines.

# Advanced Seed Option

An [advanced option to this seed exists here](https://github.com/NathanWalker/angular-starter-template-advanced) which shows examples of how this seed can be expanded to support:
...
- [angulartics2](https://github.com/angulartics/angulartics2) Vendor-agnostic analytics for Angular applications.
  - Out of box support for [Segment](https://segment.com/)
    - When using the seed, be sure to change your `write_key` [here](https://github.com/NathanWalker/angular-starter-template-advanced/blob/master/src/client/index.html#L24)
...
Forks of this project demonstrate how to extend and integrate with other libraries:
 ...
 - https://github.com/vyakymenko/angular-starter-template-express - integration with [Express](https://expressjs.com/) full-stack development.
 - https://github.com/UIUXEngineering/angular2-jspm-typescript-seed - integration with [JSPM](http://jspm.io/).
 - http://ngbot.io - a chat bot built with angular-starter-template.
 - [angular-starter-template-inspinia](https://github.com/DmitriyPotapov/angular-starter-template-inspinia) - integration with custom design template
 ...
 - https://github.com/vyakymenko/angular-lib-starter-pack - sample how to create your library compatible with [Angular Seed](https://github.com/andreslon/angular-starter-template) with [integration guide](https://github.com/vyakymenko/angular-lib-starter-pack#test-your-library-with-angular-starter-template-or-angular-starter-template-express).
