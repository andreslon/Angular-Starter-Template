 ...
 *
 * 1) https://github.com/andreslon/angular-starter-template/tree/master/tools
 * 2) https://github.com/andreslon/angular-starter-template/wiki
 *
 *****************************************************************/
...
export class SeedConfig {
  ...
  */
   ...
   * @type {string}
   */
  APP_TITLE = 'Welcome to angular-starter-template!';
